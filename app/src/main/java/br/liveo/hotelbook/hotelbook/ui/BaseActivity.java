package br.liveo.hotelbook.hotelbook.ui;
...
import br.liveo.hotelbook.hotelbook.settings.SettingsActivity;
import br.liveo.hotelbook.hotelbook.settings.SettingsUtils;
import br.liveo.hotelbook.hotelbook.test.TestActivity;
import br.liveo.hotelbook.hotelbook.ui.widget.MultiSwipeRefreshLayout;
import br.liveo.hotelbook.hotelbook.ui.widget.NavDrawerItemView;
import br.liveo.hotelbook.hotelbook.ui.widget.ScrimInsetsScrollView;
import br.liveo.hotelbook.hotelbook.util.ImageLoader;
import br.liveo.hotelbook.hotelbook.util.LUtils;
import br.liveo.hotelbook.hotelbook.util.RecentTasksStyler;
...
import static br.liveo.hotelbook.hotelbook.util.LogUtils.LOGI;
...
public class BaseActivity extends AppCompatActivity implements
    ...
    protected static final int NAVDRAWER_ITEM_SEARCHES = 1;

    protected static final int NAVDRAWER_ITEM_FAVORITES = 2;

    protected static final int NAVDRAWER_ITEM_SETTINGS = 3;

    protected static final int NAVDRAWER_ITEM_ABOUTUS = 4;
    ...
    private static final int[] NAVDRAWER_TITLE_RES_ID = new int[]{
            ...
            R.string.navdrawer_item_Searches,
    ...
    private static final int[] NAVDRAWER_ICON_RES_ID = new int[]{
            ...
            R.drawable.ic_action_search,  // Explore
            R.drawable.ic_action_favorite, // Social
            R.drawable.ic_navview_settings, // Settings.
            R.drawable.ic_action_cloud, // About
    };
    ...
    //一個Runnable，當導航抽屜完成其收盤動畫中，我們應該執行
    private Runnable mDeferredOnDrawerClosedRunnable;

    private boolean mManualSyncRequest;

    //當list view 滑動改變最上方的主題顏色
    private int mThemedStatusBarColor;

    //當list view 滑動改變最下方的主題顏色
...
//    }
    ...
    private void setupNavDrawer(){
        ...
        //當側邊drawer item 太長時必須加入可滑動卷軸
        ScrimInsetsScrollView navDrawer = (ScrimInsetsScrollView)
                mDrawerLayout.findViewById(R.id.navdrawer);

        //若沒 override getSelfNavDrawerItem則預設為沒有navDrawer
        ...
        if (navDrawer != null) {
            //當navDrawer_head被點擊時，設定view image 的
        ...
        //若toolbar 不為null ， 則加入點擊icon和監聽事件
...
//                }
        ...
        // populate the nav drawer with the correct items抓取裡面的值
        populateNavDrawer();
...
//            mDrawerLayout.openDrawer(GravityCompat.START);
    ...
    private void populateNavDrawer() {
        //建立 array 初始值對應制定義的值
        //array list package item
        mNavDrawerItems.clear();
        mNavDrawerItems.add(NAVDRAWER_ITEM_HOME);
        mNavDrawerItems.add(NAVDRAWER_ITEM_SEARCHES);
        mNavDrawerItems.add(NAVDRAWER_ITEM_FAVORITES);
        mNavDrawerItems.add(NAVDRAWER_ITEM_SEPARATOR);//線條
    ...
    private void goToNavDrawerItem(int item) {
        switch (item) {
            case NAVDRAWER_ITEM_HOME:
                ...
                break;
            case NAVDRAWER_ITEM_SEARCHES:
                createBackStack(new Intent(this, TestActivity.class));
                break;
...
//    };
    ...
    protected void onActionBarAutoShowOrHide(boolean shown) {
        //mStatusBarColorAnimator本身為主題顏色
        if (mStatusBarColorAnimator != null) {
            mStatusBarColorAnimator.cancel();
        }
        //加入mStatusBarColorAnimator主題動畫(主要是滾動時是否需要顯示主題顏色)
